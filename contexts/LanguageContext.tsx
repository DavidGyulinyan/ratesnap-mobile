...
const translations = {
  en: {
    ...
    'rateAlerts.createButtonShort': '+ Alert',
    'rateAlerts.tapToSelect': 'Tap an alert to select',
    'rateAlerts.editShort': 'Edit',
    'rateAlerts.resetShort': 'Reset',
    'rateAlerts.deleteSelectedTitle': 'Delete selected alerts?',
    'rateAlerts.deleteSelectedMessage': 'Delete {count} alert(s)?',
    'rateAlerts.resetSelectedMessage': 'Reset {count} notified alert(s)?',
    ...
    'saved.pairAt': 'Saved @',
    'saved.amountRequiredTitle': 'Enter an amount',
    'saved.amountRequiredMessage':
      'Enter how much you are converting (e.g. 500 USD) before saving this rate.',
    'saved.noConversionAmount': 'Amount not recorded for this save',
    'saved.tapToSelect': 'Tap a rate to select',
    'saved.selectedCount': '{count} selected',
    'saved.selectAll': 'Select all',
    'saved.clearSelection': 'Clear',
    'saved.openInConverter': 'Open in converter',
    'saved.openInConverterShort': 'Converter',
    'saved.deleteSelectedTitle': 'Delete saved rates?',
    'saved.deleteSelectedMessage':
      'Delete {count} saved rate(s)? This cannot be undone.',
    'saved.now': 'Now',
    'saved.at': 'at',
    ...
    'multi.addCurrencyShort': '+ Add',
    'multi.convertTo': 'Convert To',
    'multi.tapToSelect': 'Tap a currency to select',
    'multi.editCurrency': 'Change currency',
    'multi.editShort': 'Edit',
    'multi.deleteAll': 'Delete All',
    'multi.deleteAllTitle': 'Remove all currencies?',
    'multi.deleteAllConfirm': 'Remove all target currencies from this list?',
    'multi.deleteSelectedTitle': 'Remove selected currencies?',
    'multi.deleteSelectedMessage':
      'Remove {count} currency(ies) from the list?',
    'multi.showMoreTargets': 'Show more (up to 20)',
    ...
    'calculator.applyResult': 'Use result',
    'calculator.error': 'Error',
    'calculator.errorInvalid': 'Error',
    'calculator.livePreview': 'Preview',
  ...
  hy: {
    ...
    'multi.addCurrencyShort': '+ Ավել.',
    'multi.convertTo': 'Փոխանակել',
    'multi.tapToSelect': 'Հպեք՝ ընտրելու համար',
    'multi.editCurrency': 'Փոխել արժույթը',
    'multi.editShort': 'Խմբագր.',
    'multi.deleteAll': 'Բոլորը',
    'multi.deleteAllTitle': 'Հեռացնե՞լ բոլորը',
    'multi.deleteAllConfirm': 'Հեռացնե՞լ բոլոր արժույթները։',
    'multi.deleteSelectedTitle': 'Հեռացնե՞լ ընտրվածները',
    'multi.deleteSelectedMessage': 'Հեռացնե՞լ {count} արժույթ։',
    'multi.showMoreTargets': 'Ցույց տալ ավելին (մինչև 20)',
    ...
    'saved.amountRequiredTitle': 'Մուտքագրեք գումարը',
    'saved.amountRequiredMessage':
      'Պահպանելուց առաջ մուտքագրեք, թե որքան եք փոխարկում (օր. 500 USD)։',
    'saved.noConversionAmount': 'Գումարը չի պահպանվել',
    'saved.tapToSelect': 'Հպեք՝ ընտրելու համար',
    'saved.selectedCount': '{count} ընտրված',
    'saved.selectAll': 'Բոլորը',
    'saved.clearSelection': 'Մաքրել',
    'saved.openInConverter': 'Բացել փոխարկիչում',
    'saved.openInConverterShort': 'Փոխարկիչ',
    'saved.deleteSelectedTitle': 'Ջնջե՞լ պահպանված դրույքները',
    'saved.deleteSelectedMessage':
      'Ջնջե՞լ {count} պահպանված դրույք(եր)։ Գործողությունը հետարկելի չէ։',
    'saved.now': 'Այժմ',
    'saved.at': 'ժամը',
    ...
    'rateAlerts.createButtonShort': '+ Ծանուցում',
    'rateAlerts.tapToSelect': 'Հպեք՝ ընտրելու համար',
    'rateAlerts.editShort': 'Խմբ.',
    'rateAlerts.resetShort': 'Վեր.',
    'rateAlerts.deleteSelectedTitle': 'Հեռացնել ընտրվածները?',
    'rateAlerts.deleteSelectedMessage': 'Հեռացնել {count} ծանուցում?',
    'rateAlerts.resetSelectedMessage': 'Վերակայել {count} ծանուցում?',
    ...
    'calculator.applyResult': 'Օգտագործել',
    'calculator.error': 'Սխալ',
    'calculator.errorInvalid': 'Սխալ',
    'calculator.livePreview': 'Նախադիտում',
    'calculator.buttonC': 'C',
    'calculator.buttonBackspace': '⌫',
    'calculator.buttonPercent': '%',
    'calculator.buttonDivide': '÷',
  ...
  ru: {
    ...
    'multi.addCurrencyShort': '+ Добавить',
    'multi.convertTo': 'Конвертировать в',
    'multi.tapToSelect': 'Нажмите для выбора',
    'multi.editCurrency': 'Изменить валюту',
    'multi.editShort': 'Изменить',
    'multi.deleteAll': 'Все',
    'multi.deleteAllTitle': 'Удалить все валюты?',
    'multi.deleteAllConfirm': 'Удалить все валюты из списка?',
    'multi.deleteSelectedTitle': 'Удалить выбранные?',
    'multi.deleteSelectedMessage': 'Удалить {count} валют(ы)?',
    'multi.showMoreTargets': 'Показать ещё (до 20)',
    ...
    'saved.amountRequiredTitle': 'Введите сумму',
    'saved.amountRequiredMessage':
      'Перед сохранением укажите сумму конвертации (например, 500 USD).',
    'saved.noConversionAmount': 'Сумма не сохранена',
    'saved.tapToSelect': 'Нажмите для выбора',
    'saved.selectedCount': 'Выбрано: {count}',
    'saved.selectAll': 'Все',
    'saved.clearSelection': 'Сбросить',
    'saved.openInConverter': 'Открыть в конвертере',
    'saved.openInConverterShort': 'Конвертер',
    'saved.deleteSelectedTitle': 'Удалить сохранённые курсы?',
    'saved.deleteSelectedMessage':
      'Удалить {count} сохранённых курсов? Это нельзя отменить.',
    'saved.now': 'Сейчас',
    'saved.at': 'в',
    ...
    'calculator.applyResult': 'Применить',
    'calculator.error': 'Ошибка',
    'calculator.errorInvalid': 'Ошибка',
    'calculator.livePreview': 'Предпросмотр',
    'calculator.buttonC': 'C',
    'calculator.buttonBackspace': '⌫',
    'calculator.buttonPercent': '%',
    'calculator.buttonDivide': '÷',
    ...
    'rateAlerts.createButtonShort': '+ Оповещение',
    'rateAlerts.tapToSelect': 'Нажмите для выбора',
    'rateAlerts.editShort': 'Изменить',
    'rateAlerts.resetShort': 'Сброс',
    'rateAlerts.deleteSelectedTitle': 'Удалить выбранные?',
    'rateAlerts.deleteSelectedMessage': 'Удалить {count} оповещ.?',
    'rateAlerts.resetSelectedMessage': 'Сбросить {count} оповещ.?',
