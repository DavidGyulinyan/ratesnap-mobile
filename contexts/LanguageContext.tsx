...
const translations = {
  en: {
    ...
    'osWidgets.instructionsAndroid': 'Long-press your home screen → Widgets → search for Capital. Choose “Capital — Rate” or “Capital — Saved rates”, then pick your currencies when prompted.',
    'osWidgets.instructionsIos': 'Long-press home screen → + → Capital → “Capital Rates”. Then tap Sync widget data in the app.',
    'osWidgets.requiresDevBuild': 'Home screen widgets need a development or store build (not Expo Go). Run: npx expo run:android or npx expo run:ios',
    ...
    'osWidgets.androidRateWidget': 'Capital — Rate (single pair)',
    'osWidgets.androidSavedWidget': 'Capital — Saved rates',
  ...
  hy: {
    ...
    'osWidgets.instructionsAndroid': 'Հիմնական էկրանին երկար սեղմեք → Widgets → Capital → «Capital — Rate» կամ «Capital — Saved rates»։',
    'osWidgets.instructionsIos': 'Հիմնական էկրանին երկար սեղմեք → + → Capital → «Capital Rates»։ Հավելվածում սեղմեք Sync։',
    'osWidgets.requiresDevBuild': 'Վիջեթները աշխատում են dev/store build-ում (ոչ Expo Go)։',
    ...
    'osWidgets.androidRateWidget': 'Capital — Rate',
    'osWidgets.androidSavedWidget': 'Capital — Saved rates',
  ...
  ru: {
    ...
    'osWidgets.instructionsAndroid': 'Долгое нажатие на главный экран → Виджеты → Capital → «Capital — Rate» или «Capital — Saved rates».',
    'osWidgets.instructionsIos': 'Долгое нажатие → + → Capital → «Capital Rates». В приложении нажмите Sync.',
    'osWidgets.requiresDevBuild': 'Виджеты работают в dev/store сборке (не Expo Go).',
