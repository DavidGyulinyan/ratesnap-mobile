...
const translations = {
  en: {
    ...
    'osWidgets.title': 'Home screen widgets',
    'osWidgets.subtitle': 'Put live rates on your phone home screen. Sync after refreshing rates in the app.',
    'osWidgets.preview': 'Preview',
    'osWidgets.pickPair': 'Default pair for widgets',
    'osWidgets.savePreset': 'Save as default pair',
    'osWidgets.syncNow': 'Sync widget data',
    'osWidgets.notSyncedYet': 'Not synced yet',
    'osWidgets.savedPresets': 'Saved presets',
    'osWidgets.presetRatePair': 'Rate pair',
    'osWidgets.presetSavedRates': 'Saved rates',
    'osWidgets.addToHomeTitle': 'Add to home screen',
    'osWidgets.instructionsAndroid': 'Long-press your home screen → Widgets → search “Capital”. Add “Capital rates” or “Capital saved”, then choose currencies when prompted. If nothing appears, install a fresh build (see banner above).',
    'osWidgets.instructionsIos': 'Long-press home screen → + → Capital → “Capital Rates”. Then tap Sync widget data in the app. Widgets do not work in Expo Go.',
    'osWidgets.requiresExpoGo': 'You are in Expo Go. Home screen widgets are not included. Build and install the app: npx expo prebuild --clean, then npx expo run:android (or eas build --profile preview --platform android) and open that install—not Expo Go.',
    'osWidgets.requiresNativeRebuild': 'This install has no widget native code (eas update cannot add widgets). Run: eas build --profile preview --platform android — then install the new APK on your phone. Your last EAS build was before widgets were added.',
    'osWidgets.requiresDevBuild': 'If “Capital” is still missing after installing a new build, run npx expo prebuild --clean and rebuild.',
    'osWidgets.unsupportedPlatform': 'Home screen widgets are available on iOS and Android only.',
    'osWidgets.settingsSubtitlePro': 'Configure and sync home screen widgets',
    'osWidgets.configureTitle': 'Widget setup',
    'osWidgets.configureRatePair': 'Choose the currency pair shown on this widget.',
    'osWidgets.configureSavedRates': 'This widget shows your saved rates from the app.',
    'osWidgets.addToHome': 'Add widget',
    'osWidgets.androidRateWidget': 'Capital rates (single pair)',
    'osWidgets.androidSavedWidget': 'Capital saved',
  ...
  hy: {
    ...
    'osWidgets.title': 'Հիմնական էկրանի վիջեթներ',
    'osWidgets.subtitle': 'Դրույքները ցուցադրեք հեռախոսի հիմնական էկրանին։ Հավելվածում թարմացրեք դրույքները, ապա սեղմեք Sync։',
    'osWidgets.preview': 'Նախադիտում',
    'osWidgets.pickPair': 'Լռելյայն զույգ',
    'osWidgets.savePreset': 'Պահպանել որպես լռելյայն',
    'osWidgets.syncNow': 'Համաժամեցնել վիջեթը',
    'osWidgets.notSyncedYet': 'Դեռ չի համաժամեցվել',
    'osWidgets.savedPresets': 'Պահված կարգավորումներ',
    'osWidgets.presetRatePair': 'Զույգ',
    'osWidgets.presetSavedRates': 'Պահված դրույքներ',
    'osWidgets.addToHomeTitle': 'Ավելացնել հիմնական էկրանին',
    'osWidgets.instructionsAndroid': 'Հիմնական էկրանին երկար սեղմեք → Widgets → «Capital» → «Capital rates» կամ «Capital saved»։ Եթե չկա, տեղադրեք նոր native build (տես վերևի նախազգուշացումը)։',
    'osWidgets.instructionsIos': 'Հիմնական էկրանին երկար սեղմեք → + → Capital → «Capital Rates»։ Sync-ը հավելվածում է։ Expo Go-ում վիջեթներ չկան։',
    'osWidgets.requiresExpoGo': 'Դուք Expo Go-ում եք։ Վիջեթները չեն աշխատում։ Կատարեք eas build --profile preview --platform android և տեղադրեք նոր APK-ն, ոչ Expo Go-ն։',
    'osWidgets.requiresNativeRebuild': 'Այս տեղադրումը widget native կոդ չունի (eas update-ը չի ավելացնում)։ eas build --profile preview --platform android, ապա տեղադրեք նոր APK-ն։',
    'osWidgets.requiresDevBuild': 'Եթե «Capital»-ը դեռ չկա, npx expo prebuild --clean և նոր build։',
    'osWidgets.unsupportedPlatform': 'Միայն iOS և Android։',
    'osWidgets.settingsSubtitlePro': 'Կարգավորել հիմնական էկրանի վիջեթները',
    'osWidgets.configureTitle': 'Վիջեթի կարգավորում',
    'osWidgets.configureRatePair': 'Ընտրեք արժույթների զույգը։',
    'osWidgets.configureSavedRates': 'Վիջեթը ցույց է տալիս պահված դրույքները։',
    'osWidgets.addToHome': 'Ավելացնել',
    'osWidgets.androidRateWidget': 'Capital rates',
    'osWidgets.androidSavedWidget': 'Capital saved',
  ...
  ru: {
    ...
    'osWidgets.title': 'Виджеты главного экрана',
    'osWidgets.subtitle': 'Курсы на домашнем экране. Обновите курсы в приложении и нажмите Sync.',
    'osWidgets.preview': 'Превью',
    'osWidgets.pickPair': 'Пара по умолчанию',
    'osWidgets.savePreset': 'Сохранить пару',
    'osWidgets.syncNow': 'Синхронизировать',
    'osWidgets.notSyncedYet': 'Ещё не синхронизировано',
    'osWidgets.savedPresets': 'Сохранённые настройки',
    'osWidgets.presetRatePair': 'Пара',
    'osWidgets.presetSavedRates': 'Сохранённые курсы',
    'osWidgets.addToHomeTitle': 'Добавить на главный экран',
    'osWidgets.instructionsAndroid': 'Долгое нажатие на главный экран → Виджеты → «Capital» → «Capital rates» или «Capital saved». Если нет — установите новую native-сборку (см. баннер выше).',
    'osWidgets.instructionsIos': 'Долгое нажатие → + → Capital → «Capital Rates». Sync в приложении. В Expo Go виджеты недоступны.',
    'osWidgets.requiresExpoGo': 'Вы в Expo Go — виджеты не поддерживаются. Соберите: eas build --profile preview --platform android и установите APK, не Expo Go.',
    'osWidgets.requiresNativeRebuild': 'В этой установке нет native-кода виджетов (eas update не добавляет их). Запустите: eas build --profile preview --platform android и установите новый APK.',
    'osWidgets.requiresDevBuild': 'Если «Capital» всё ещё нет — npx expo prebuild --clean и новая сборка.',
    'osWidgets.unsupportedPlatform': 'Только iOS и Android.',
    'osWidgets.settingsSubtitlePro': 'Настройка виджетов главного экрана',
    'osWidgets.configureTitle': 'Настройка виджета',
    'osWidgets.configureRatePair': 'Выберите валютную пару.',
    'osWidgets.configureSavedRates': 'Виджет показывает сохранённые курсы.',
    'osWidgets.addToHome': 'Добавить',
    'osWidgets.androidRateWidget': 'Capital rates',
    'osWidgets.androidSavedWidget': 'Capital saved',
