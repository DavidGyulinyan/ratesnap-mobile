...
const translations = {
  ...
  hy: {
    ...
    'saved.signInPrompt': 'Մուտք գործեք՝ ձեր արժույթի դրույքները պահպանելու և համաժամանակեցնելու համար սարքերի միջև:',
    'saved.emptyState': 'Դեռևս պահպանված դրույքներ չկան: Փոխարկեք արժույթները և սեղմեք "Պահպանել այս դրույքը" որպեսզի որևէ բան ավելացնեք:',
    ...
    'rateAlerts.conditionAlreadyMetMessage': '{fromCurrency} → {toCurrency} ընթացիկ փոխարժեքը {currentRate} է, որն արդեն {condition} է ձեր {targetRate} թիրախից: Ծանուցումը կմիացի անմիջապես:',
