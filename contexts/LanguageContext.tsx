...
const translations = {
  en: {
    ...
    'osWidgets.requiresExpoGo': 'You are in Expo Go. Home screen widgets are not included. Build and install the app: npx expo prebuild --clean, then npx expo run:android (or eas build --profile development --platform android) and open that install—not Expo Go.',
    'osWidgets.requiresDevBuild': 'If “Capital” is missing from the widget list, this install was built without widget native code. Run npx expo prebuild --clean, then npx expo run:android (or a new EAS build) and reinstall on your phone.',
  ...
  hy: {
    ...
    'osWidgets.requiresExpoGo': 'Դուք Expo Go-ում եք։ Վիջեթները չեն աշխատում։ Կատարեք npx expo prebuild --clean, ապա npx expo run:android (կամ EAS development build) և բացեք այդ տեղադրումը, ոչ Expo Go-ն։',
    'osWidgets.requiresDevBuild': 'Եթե «Capital»-ը չի երևում, տեղադրեք նոր build՝ npx expo prebuild --clean և npx expo run:android (կամ EAS)։',
  ...
  ru: {
    ...
    'osWidgets.requiresExpoGo': 'Вы в Expo Go — виджеты не поддерживаются. Соберите приложение: npx expo prebuild --clean, затем npx expo run:android (или eas build --profile development) и откройте эту установку, не Expo Go.',
    'osWidgets.requiresDevBuild': 'Если «Capital» нет в списке виджетов, переустановите сборку: npx expo prebuild --clean и npx expo run:android (или новый EAS build).',
